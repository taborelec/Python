...
xF = xF[range(int(len(wav1)/2))]+2.7E9
...
inst_addr = 'TCPIP::169.254.69.41::5025::SOCKET'
inst_addr = 'TCPIP::169.254.3.195::5025::SOCKET' #Proteus Local Lan
